...
const experiences = [
  {
    ...
    points: [
      ...
      'Engineered self-service **API ecosystem** empowering **15+ healthcare partners** to integrate student health data through **FHIR/HL7-compliant RESTful APIs**, featuring **interactive documentation**, **usage analytics**, and **real-time status monitoring** for **HIPAA-compliant healthcare interoperability**',
  ...
  },
  {
    ...
    points: [
      ...
      'Launched **revenue-generating SaaS** solution by integrating **Stripe billing**, **Google SSO**, and **tiered subscription management**, transforming DataChat from internal tool into **commercial no-code analytics platform** serving **enterprise customers**',
      'Resolved **database integration bottlenecks** by building test-before-connect architecture, unlocking real-time visualization across **Snowflake**, **BigQuery**, **Redshift**, **Databricks**, and **15+ other data sources** for no-code analytics',
      ...
      'Streamlined **deployment provisioning** using **Terraform** and **AWS EKS**, implementing **multi-AZ Kubernetes clusters** with **S3 state management** that **reduced customer environment deployment from manual weeks to automated hours**',
      'Built **end-to-end testing framework** using **Cypress** and **Go/Flask test suites**, validating conversational AI accuracy across **15+ data sources** with automated **regression testing**.',
      'Implemented **distributed messaging infrastructure** using **RabbitMQ** and **AMQP protocols**, implementing self-interrupting request optimization and async message handling that **resolved request bottlenecks** for real-time analytics workloads',
    ],
    tech_stack: [
      'React.js',
      'TypeScript',
